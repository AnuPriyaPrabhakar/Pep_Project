...
class AdminUserApiService {
    ...
    doMasterAdminUser = async (payload: AdminUserPayload) => {
        console.log("AdminUserApiService doMasterAdminUser() start = " + JSON.stringify(payload));
        try {
    ...
    updateAdminUser = async (id: string, payload: AdminUserPayload) => {
        console.log("AdminUserApiService updateAdminUser() start = " + JSON.stringify(payload));
        try {
