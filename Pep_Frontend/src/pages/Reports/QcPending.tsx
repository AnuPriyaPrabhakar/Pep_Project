...
import QcPendingApiService from '../../data/services/Reports/QcPending/qcpending-api-service';
import { QcPendingData } from '../../data/services/Reports/QcPending/qcpending-payload';
...
function QcPending() {
    ...
    const qcPendingApiService = new QcPendingApiService();
    ...
    const handleSearch = () => {
            ...
            qcPendingApiService.getCustomDate(startDateAsDate, endDateAsDate)
            .then((fetchedData: QcPendingData[]) => {
    ...
    return (
        <>
          <h4 style={{ marginTop: '6%', marginLeft: '2%' }}>Qc Pending</h4>
            <Header />
