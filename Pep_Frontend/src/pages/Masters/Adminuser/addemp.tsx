...
const AddEmp = () => {
    ...
    const handleUserNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (!userNameRegex.test(userNameValue)) {
            setuserNameError('Only alphabets, numbers, and underscores are allowed');
            setuserName('');
        } else {
            setuserNameError('');
        ...
        <>
            ...
            <div>
                <Box mt={12} display="flex" justifyContent="center">
                    <Card style={{ width: '90%' }}>
                        <Box mt={6}>
                            <h3 style={{ marginLeft: '2%', marginTop: '-3%' }}>Employee Registration:</h3>
                            <form onSubmit={onSubmitAddEmployee}>
                                ...
                                <div style={{ marginTop: '-2%', marginRight: '3%' }}>
                                    <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                        <button className='btn btn-primary' type='submit' disabled={!isPasswordValid}>
                                            Submit
                                        </button>
                                    </div>
                                </div>
