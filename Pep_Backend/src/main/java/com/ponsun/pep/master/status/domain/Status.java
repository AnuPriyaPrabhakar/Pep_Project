package com.ponsun.pep.master.status.domain;
...
public class Status extends BaseEntity {
    ...
    public static Status create(final CreateStatusRequest createStatusRequest) {
        ...
        status.setStatus(com.ponsun.pep.common.entity.Status.ACTIVE);
    ...
    public void update(final UpdateStatusRequest updateStatusRequest){
        ...
        this.setStatus(com.ponsun.pep.common.entity.Status.ACTIVE);
