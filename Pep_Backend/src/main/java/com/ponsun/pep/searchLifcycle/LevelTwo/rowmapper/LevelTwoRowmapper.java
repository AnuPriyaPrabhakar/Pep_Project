package com.ponsun.pep.searchLifcycle.LevelTwo.rowmapper;

import com.ponsun.pep.searchLifcycle.LevelTwo.data.LevelTwoData;
import lombok.Data;
...
public class LevelTwoRowmapper implements RowMapper<LevelTwoData> {
    ...
    public LevelTwoRowmapper(){
        ...
        builder.append(" FROM search a,hitrecord b,crm_criminal_name c,pep_config_country d,pep_config_state e,hitrecord_lifecycle f");
