package com.ponsun.pep.searchLifcycle.hitcase.rowmapper;

import com.ponsun.pep.searchLifcycle.hitcase.data.HitCaseData;
...
//        builder.append("ch.dt as dt, ");
    ...
    @Override
        ...
        final Long cycleId = rs.getLong("cycleId");
