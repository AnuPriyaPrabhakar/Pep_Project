package com.ponsun.pep.searchLifcycle.PendingCase.rowmapper;
...
public PendingCaseRowmapper(){
    ...
    final StringBuilder builder = new StringBuilder(200);
    builder.append(" FROM pep_search a,hitrecord b, hitrecord_lifecycle c,hitcase d");
    this.schema = builder.toString();
}
    ...
    public String tableSchema(){
        final StringBuilder builder = new StringBuilder(200);
        builder.append(" a.name AS searchName , d.id AS caseId,a.id AS searchId, b.id AS hitId, b.criminalid AS criminalId, b.name AS criminalName, b.matchingscore AS matchingScore,c.remark AS remark");
    ...
    public PendingCaseData mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        return PendingCaseData.newInstance(caseId, criminalId, hitId, 0,searchId,0,0,criminalName,matchingScore, remark,searchName);
    }
