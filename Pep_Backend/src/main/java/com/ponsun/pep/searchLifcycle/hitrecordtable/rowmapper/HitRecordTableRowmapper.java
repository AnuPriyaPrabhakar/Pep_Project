package com.ponsun.pep.searchLifcycle.hitrecordtable.rowmapper;
...
//    WHERE a.id=b.search_id AND b.criminal_id=c.id AND a.country_id=d.id AND a.state_id=e.id AND a.level_id=1;
    ...
    public HitRecordTableRowmapper() {
        ...
        builder.append(" FROM crm_search a,crm_hitdata b,crm_criminal_name c,crm_config_country d,crm_config_state e");
