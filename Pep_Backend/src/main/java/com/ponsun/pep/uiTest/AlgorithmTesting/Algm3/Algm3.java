package com.ponsun.pep.uiTest.AlgorithmTesting.Algm3;
...
public class Algm3 {
    ...
    public static double algorithm3(String nametest1,String nametest2) {
        // Declare two names for comparison
//        String nametest1 = "ibrahim dawood";
//        String nametest2 = "daud ibrahim";
        ...
        while(l1<token1.size() && l2<token2.size()) {
            ...
            while(l2<token2.size() && l1<token1.size()) {
                ...
                if(token1.get(l1).length()==1 || token2.get(l1).length()==1 && similar.size()!=0) {
                    ...
                    token1.set(l1, soundex.encode(token1.get(l1)));
                    token2.set(l2, soundex.encode(token2.get(l2)));
