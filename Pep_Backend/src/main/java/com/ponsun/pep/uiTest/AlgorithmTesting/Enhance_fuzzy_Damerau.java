package com.ponsun.pep.uiTest.AlgorithmTesting;

import me.xdrop.fuzzywuzzy.FuzzySearch;

import java.util.ArrayList;

public class Enhance_fuzzy_Damerau {
    public static String disAlgm="Damerau";
    public static double Main_fuzzy_Damerau(String name1,String name2) {
