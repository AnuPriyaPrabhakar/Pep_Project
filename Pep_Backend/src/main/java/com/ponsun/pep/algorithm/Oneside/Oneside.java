package com.ponsun.pep.algorithm.Oneside;
...
//      		  System.out.println(l1+"   "+l2+token1.get(l1)+"   "+token2.get(l2));
                if((token1.get(l1).length()==1 || token2.get(l2).length()==1) && similar.size()!=0) {
                    ...
                    if(token2.get(l2).length()==2 && token2.get(l2)==token1.get(l1).substring(0, 2)) {
                        issingle=true;
                    }
                    ...
                    if(token1.get(l1).length()==2  && token1.get(l1)==token2.get(l2).substring(0, 2)) {
                        issingle=true;
                    }
